...
var (
	// TODO: Replace this project name and model name with my configuration.
	project = "around-237801"
	model   = "face"
...
func annotate(r io.Reader) (float64, error) {
	...
	// Double check if the response is empty. Sometimes Google does not return an error instead just
	// an empty response while usually it's due to auth
	if len(body) == 0 {
	...
	// TODO: update index based on my ml code
